...
<div class="flex items-center justify-center bg-green min-h-screen">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form wire:submit.prevent="save" class="space-y-4">
            ...
            <div class="flex justify-end mt-6">
                <button type="submit" 
                        class="bg-indigo-600 text-white px-4 py-2 rounded-md shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-600">
                    Save
                </button>
            </div>
        </form>
